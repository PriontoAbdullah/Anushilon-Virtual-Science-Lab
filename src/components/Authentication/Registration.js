							...
							<form className="max-w-lg px-10 py-6 m-auto bg-white bg-opacity-25 rounded shadow-xl font-body">
								...
								<Slide bottom cascade>
									<div className="mt-4 font-body">
										<div class="relative flex w-full flex-wrap items-stretch mb-3">
											<span className="login-icon">
												<FontAwesomeIcon icon={faUniversity} className="text-gray-700" />
											</span>
											<input
									...
									<div className="mt-4 font-body">
										<div class="relative flex w-full flex-wrap items-stretch mb-3">
											<span className="login-icon">
												<FontAwesomeIcon icon={faSchool} className="text-gray-700" />
											</span>
											<input
									...
									<div className="mt-4 font-body">
										<div class="relative flex w-full flex-wrap items-stretch mb-3">
											<span className="login-icon">
												<FontAwesomeIcon icon={faMapMarkedAlt} className="text-gray-700" />
											</span>
											<input
									...
									<div className="mt-4 font-body">
										<div class="relative flex w-full flex-wrap items-stretch mb-3">
											<span className="login-icon">
												<FontAwesomeIcon icon={faRegistered} className="text-gray-700" />
											</span>
											<input
									...
									<div className="mt-4 font-body">
										...
										<div class="relative flex w-full flex-wrap items-stretch mb-3">
											<span class="login-icon">
												<FontAwesomeIcon icon={faUnlock} className="text-gray-700" />
											</span>
											<input
