...
function SearchBar() {
	...
	return (
		<div>
			...
			<button
				ref={trigger}
				className={`w-8 h-8 flex items-center justify-center bg-gray-100 hover:bg-gray-200 transition duration-150 rounded-full ml-3 outline-none focus:outline-none ${searchOpen &&
					'bg-gray-200'}`}
				onClick={() => {
