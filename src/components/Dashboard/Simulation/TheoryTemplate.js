	...
	return (
		<div className="flex flex-wrap text-lg font-body text-gray-900 leading-relaxed tracking-wide">
			...
			<div className="mb-2">
				...
				<p>
					একটি মিটার ব্রিজ ব্যবহার করে প্রদত্ত তারের প্রতিরোধের সন্ধান করতে এবং তার উপাদানগুলির নির্দিষ্ট
			...
			<div className="mb-4">
				...
				<p>
					মিটার ব্রিজটি হুইটস্টনের নীতির অধীনে পরিচালিত হয়। এখানে, চারটি প্রতিরোধক P, Q, R, এবং S নেটওয়ার্ক
					ABCD গঠনের জন্য সংযুক্ত রয়েছে। টার্মিনাল A এবং C একটি ব্যাটারির সাথে সংযুক্ত এবং C এবং D
					টার্মিনালগুলি যথাক্রমে K1 এবং K2 কীগুলির মাধ্যমে একটি গ্যালভানোমিটারের সাথে সংযুক্ত থাকে।
					ভারসাম্যহীন অবস্থায় গ্যালভানোমিটারের কোনও প্রতিচ্ছবি নেই। অতঃপর,
				</p>
			...
			<div className="mb-2 mt-2">
				...
				<p>
					স্লাইড ওয়্যার ব্রিজ নামে পরিচিত মিটার ব্রিজটি কাঠের ব্লকের উপর স্থিত ইউনিফর্ম ক্রস-বিভাগীয় অঞ্চলের
					এক মিটার দীর্ঘ তারের সমন্বয়ে গঠিত। একটি স্কেল ব্লকের সাথে সংযুক্ত থাকে। গমের পাথরের ব্রিজটি তৈরি
					করার জন্য ঘন ধাতব স্ট্রিপগুলি ব্যবহার করে এর উপর দুটি ফাঁক তৈরি হয়। ফাঁকগুলির মধ্যে টার্মিনাল B
					গ্যালভানোমিটার এবং জকি সংযোগ করতে ব্যবহৃত হয়।
				</p>
				...
				<p>
					ফাঁক S তে একটি প্রতিরোধের তারের প্রবর্তন করা হয় এবং প্রতিরোধের বাক্সটি ফাঁক R এ থাকে। যখন জকি তারের
			...
			<div className="mb-4">
				...
				<p className="mt-2">
					তারের উপাদানের নির্দিষ্ট প্রতিরোধ বা প্রতিরোধের পরে সম্পর্কটি ব্যবহার করে গণনা করা যেতে পারে,
				</p>
			...
			<div className="pb-5">
				...
				<ul className="list-inside leading-loose list-disc">
					<li>শিক্ষার্থীরা হুইটস্টোন ব্রিজ এবং হুইটস্টোন এর নীতিটি বুঝতে পারবে।</li>
					<li>শিক্ষার্থীরা হুইটস্টোন এর নীতি যাচাই করতে পারবে।</li>
					<li>শিক্ষার্থীরা মিটার ব্রিজ পরীক্ষার মাধ্যমে হুইটসটনের ব্রিজের নীতিটি বুঝতে সক্ষম হবে।</li>
				</ul>
			</div>
		</div>
	);
