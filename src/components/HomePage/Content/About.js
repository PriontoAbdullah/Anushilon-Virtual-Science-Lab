						...
						<div className="max-w-xl mb-6">
							...
							<Fade bottom>
								<p className="text-base text-gray-700 font-body md:text-lg">
									এটি একটি ওয়েব-ভিত্তিক প্ল্যাটফর্ম যা বাংলাদেশের স্কুল এবং কলেজগুলিতে শিক্ষার্থীদের
									জন্য নিরাপদ এবং ইন্টারেক্টিভ ল্যাব এর পরিবেশ প্রদান করে যা শেখার পদ্ধতি উন্নতির জন্য
									ডিজাইন করা হয়েছে।
								</p>
							</Fade>
						</div>
							...
							<div>
								<Fade bottom>
									...
									<p className="text-sm text-gray-800">
										এই ভার্চুয়াল ল্যাবটি বিজ্ঞান পাঠদান প্রক্রিয়াটিকে উন্নত করতে স্কুল এবং কলেজের
										শিক্ষার্থীদের বিজ্ঞান ল্যাবগুলির বিকল্প হিসাবে তৈরি করা হয়েছে।
									</p>
								</Fade>
							</div>
							<div>
								<Fade bottom>
									...
									<p className="text-sm text-gray-800">
										এই ভার্চুয়াল সায়েন্স ল্যাবটি নিরাপদ এবং ইন্টারেক্টিভ পদ্ধতিতে শিক্ষার্থীদের
										পরীক্ষাগার পরীক্ষা চালাতে সহায়তা করার জন্য তৈরি করা হয়েছে।
									</p>
								</Fade>
							</div>
						</div>
