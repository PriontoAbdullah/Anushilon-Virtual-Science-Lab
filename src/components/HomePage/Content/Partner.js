			...
			<div className="px-4 pt-16 pb-12 mx-auto max-w-7xl">
							...
							{partnerData &&
								partnerData.map((item, index) => (
									<div className="flex items-center justify-center">
										<SwiperSlide tag="li" key={index} style={{ width: '180px' }}>
											<img
				...
				<Fade bottom>
					...
					<div className="flex justify-center mt-8">
						<Link to="/registration" className="deep-button focus:ring-0">আপনার শিক্ষা প্রতিষ্ঠানটি নিবন্ধন করুন এখনই</Link>
					</div>
				</Fade>
			</div>
		</section>
