					...
					<div className="grid grid-cols-2 gap-10 mb-3 sm:grid-cols-3 lg:grid-cols-12 lg:gap-20">
						...
						<div className="col-span-4">
							...
							<div className="mt-6 lg:max-w-sm font-body">
								<p className="text-sm text-indigo-50">
									নবম থেকে দ্বাদশ শ্রেণির পদার্থবিজ্ঞান, রসায়ন ও জীববিজ্ঞান বিষয়ের সকল ল্যাব
									এক্সপেরিমেন্ট এবং বিজ্ঞান চর্চার সকল সিমুলেশন এখন সবসময়, সম্পূর্ণ বিনামূল্যে।
								</p>
							</div>
						</div>
						{/* Column 2 */}
						...
						<div className="col-span-1 lg:col-span-2 space-y-2 text-sm font-body">
							...
							<ul className="mt-2 space-y-2">
								<li>
									<Link to="simulation" smooth={true} className="footer-category">
										আমাদের সিমুলেশন
									</Link>
								</li>
								<li>
								...
								<li>
									<Link to="testimonial" smooth={true} className="footer-category">
										লোকেরা যা বলছে
									</Link>
								</li>
								<li>
						...
						<div className="col-span-3">
							...
							<p className="mt-2 font-body text-sm text-indigo-50">
								আমরা বিশ্বাস করি যে অনুশীলন প্রযুক্তিগত আধুনিক বিজ্ঞান শিক্ষার জন্য অবকাঠামোগত অভাবের
								সমাধান হতে পারে।
							</p>
						</div>
					</div>
