export const physics12 = [
  {
    id: "phy121",
    image: require("../assets/images/simulation/phy/12/meter-bridge.jpg"),
    name: "মিটার ব্রিজ ব্যবহার করে কোন তারের আপেক্ষিক রোধ নির্ণয়।",
    title: "চলতড়িৎ - হুইটস্টোন ব্রীজ",
    route: "/phy/12/meter-bridge",
  },
  {
    id: "phy122",
    image: require("../assets/images/simulation/phy/12/concavelens.jpg"),
    name: "উত্তল লেন্সের ব্যবহার করে লেন্সের ফোকাস দূরত্ব ও ক্ষমতা নির্ণয়।",
    title: "আলোর প্রতিফলন - উত্তল লেন্স",
    route: "/phy/12/concave-lens",
  },
  {
    id: "phy123",
    image: require("../assets/images/simulation/phy/12/potentiometer.jpg"),
    name: "পটেনশিওমিটার এর সাহায্যে দুটি কোষের তড়িচ্চালক বলের তুলনা।",
    title: "চলতড়িৎ - পটেনশিওমিটার",
    route: "/phy/12/potentiometer",
  },
  {
    id: "phy124",
    image: require("../assets/images/simulation/phy/12/ohms-law.jpg"),
    name: "ওহমের সূত্র এবং রোধের সূত্রের যথার্থতা প্রমান।",
    title: "চলতড়িৎ - ওহমের সূত্র",
    route: "/phy/12/ohms-law",
  },
];

export const physics11 = [
  {
    id: "phy111",
    image: require("../assets/images/simulation/phy/11/sphero-meter.jpg"),
    name: "স্ফেরোমিটারের সাহায্যে একটি উত্তল ও অবতল বক্রতার ব্যাসার্ধ নির্ণয়।",
    title: "আলোকবিদ্যা - স্ফেরোমিটার",
    route: "/phy/11/sphero-meter",
  },
  {
    id: "phy112",
    image: require("../assets/images/simulation/phy/11/youngs-modulus.jpg"),
    name: "ভার্নিয়ার পদ্ধতিতে তারের উপাদানের ইয়ংয়ের গুণাংক নির্ণয় কর।",
    title: "বলবিদ্যা - ইয়ংয়ের গুণাংক",
    route: "/phy/11/youngs-modulus",
  },
  {
    id: "phy113",
    image: require("../assets/images/simulation/phy/11/helical-spring.jpg"),
    name: "একটি হেলিকাল স্প্রিং এর স্প্রিং বল ধ্রুবক নির্ণয়।",
    title: "বলবিদ্যা - হেলিকাল স্প্রিং",
    route: "/phy/11/helical-spring",
  },
  {
    id: "phy114",
    image: require("../assets/images/simulation/phy/11/sonometer.jpg"),
    name: "মেলডির পরীক্ষার সাহায্যে সুরশলাকার কম্পাংক নির্ণয়।",
    title: "তরঙ্গ - সুরশলাকার কম্পাংক",
    route: "/phy/11/sonometer",
  },
];
...
export const physics10 = [
  {
    id: "phy101",
    image: require("../assets/images/simulation/phy/10/vernier-calliper.jpg"),
    name: "একটি আায়তাকার বস্তুর একটি পৃষ্ঠের ক্ষেত্রফল ও বস্তুর আয়তন নির্ণয়।",
    title: "ভৌত রাশি ও পরিমাপ - স্লাইড ক্যালিপার্স",
    route: "/phy/10/vernier-calliper",
  },
  {
    id: "phy102",
    image: require("../assets/images/simulation/phy/10/screwguage.jpg"),
    name: "একটি বৃত্তাকার প্রস্থচ্ছেদ বিশিষ্ট তারের পস্থচ্ছেদের ক্ষেত্রফল নির্ণয়।",
    title: "ভৌত রাশি ও পরিমাপ - স্ক্রু গজ",
    route: "/phy/10/screw-guage",
  },
  {
    id: "phy103",
    image: require("../assets/images/simulation/phy/10/concave-mirror.jpg"),
    name: "উত্তল লেন্স ব্যবহার করে প্রতিবিম্ব সৃষ্টি এবং প্রদর্শন।",
    title: "আলোর প্রতিফলন  - উত্তল লেন্স",
    route: "/phy/10/concave-mirror",
  },
  {
    id: "phy104",
    image: require("../assets/images/simulation/phy/10/inclinedplane.jpg"),
    name: "একটি ঢালু তক্তার উপরে মর্বেল গড়িয়ে পড়তে দিয়ে গড় দ্রুতি নির্ণয়।",
    title: "গতি - আনত তল",
    route: "/phy/10/inclined-plane",
  },
];

export const physics09 = [
  {
    id: "phy091",
    image: require("../assets/images/simulation/phy/09/density-of-solid.jpg"),
    name: "কোনো বস্তুর উপর প্রযুক্ত বল পরিমাপ – স্প্রিং নিক্তির সাহায্যে।",
    title: "পদার্থের অবস্থা ও চাপ - আপেক্ষিক ঘনত্ব ",
    route: "/phy/09/density-of-solid",
  },
  {
    id: "phy092",
    image: require("../assets/images/simulation/phy/09/newtons-second-law.jpg"),
    name: "নিউটনের গতির দ্বিতীয় সূত্রের যথার্থ সত্যতা প্রমাণ।",
    title: "গতি - নিউটনের দ্বিতীয় সূত্র",
    route: "/phy/09/newtons-second-law",
  },
];
